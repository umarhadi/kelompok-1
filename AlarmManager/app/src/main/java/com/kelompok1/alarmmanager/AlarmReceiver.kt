package com.kelompok1.alarmmanager
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        //Jika ingin menampilkan dengan toast hilangkan comment pada baris dibawah.
        //showToast(context, title, message)
        showAlarmNotification(context, title, message!!, notifId)
    }

    // metode ini untuk menampilkan toast
    private fun showToast(context: Context, title: String, message: String?) {
        Toast.makeText(context, "$title : $message", Toast.LENGTH_LONG).show()
    }

    // metode ini untuk menampilkan notifikasi
    ...
    // Metode ini digunakan untuk menjalankan alarm
